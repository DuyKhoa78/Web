                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('danhmuc.update',[$danhmuc->id])}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{$danhmuc->tendanhmuc}}" name="tendanhmuc" onkeyup="ChangeToSlug();" id="slug" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Slug danh mục</label>
                            <input type="text" class="form-control" value="{{$danhmuc->slug_danhmuc}}" name="slug_danhmuc" onkeyup="ChangeToSlug();" id="convert_slug"  aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
