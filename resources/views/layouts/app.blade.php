    ...
    <script >
        $('.sachnoibat').change(function(){
            ...
            if (sachnoibat==0){
                ...
                var thongbao = 'Thay đổi sách hay thành công';
            }
            $.ajax({
                url:"{{url('/sachnoibat')}}",
                method: "POST",
                data: {sachnoibat:sachnoibat,sach_id:sach_id,_token:_token},
